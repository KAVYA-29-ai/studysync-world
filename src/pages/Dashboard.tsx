...
import { getCurrentUser, mockCommunities, mockClubs, mockChatRooms, mockAuth } from '@/lib/mockData';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              {user.role === 'mentor' && user.availableForMentorship && (
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="glass-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">{user.joinedCommunities.length}</div>
        ...
        <Card className="glass-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-secondary">{user.joinedClubs.length}</div>
            <p className="text-xs text-muted-foreground">
              +1 this week
            </p>
          </CardContent>
